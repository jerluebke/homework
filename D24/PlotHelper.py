...
class PlotHelper:
    ...
    def plot(self, clear=True):
        ...
        if self.legend_params:
            # this allows newlines in the legend
            with atwnul():
